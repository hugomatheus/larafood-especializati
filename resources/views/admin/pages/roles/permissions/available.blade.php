...
@section('title', "Vincular permissões ao cargo {{$role->name}}")

@section('content_header')
    <h1>Vincular permissões ao cargo {{$role->name}}</h1>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <a href="{{route('roles.index')}}" class="btn btn-success">Cargo</a>
                ...
                <form action="{{route('roles.permissions.attach', $role->id)}}" method="POST">
                    @csrf
                        ...
                        <div class="card-footer clearfix">
                          ...
                          <div class="row">
                            <div class="col-12">
                                <a href="{{route('roles.permissions', $role->id)}}" class="btn btn-secondary float-left">Voltar</a>
